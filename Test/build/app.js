...
/***/ function(module, exports, __webpack_require__) {
	...
	(exports.default || module.exports).manifest = {"package":"com.application.demo","name":"Test","versionName":"1.0.0","versionCode":"1","minPlatformVersion":"101","icon":"/Common/logo.png","features":[{"name":"system.prompt"},{"name":"system.router"},{"name":"system.shortcut"},{"name":"system.fetch"}],"permissions":[{"origin":"*"}],"config":{"logLevel":"debug","designWidth":640},"router":{"entry":"Demo","pages":{"Demo":{"component":"index"},"DemoDetail":{"component":"index"},"About":{"component":"index"},"StyleLayout":{"component":"index.3"},"Directive":{"component":"index.3"},"PageParams":{"component":"index"},"PageParams/receiveparams":{"component":"index"},"PageParams/pageb":{"component":"pageb"},"BindEvents":{"component":"index"}}},"display":{"titleBarBackgroundColor":"#f2f2f2","titleBarTextColor":"#414141","menu":true,"pages":{"Demo":{"titleBarText":"示例页","menu":false},"DemoDetail":{"titleBarText":"详情页"},"About":{"menu":false},"StyleLayout":{"menu":false},"Directive":{"menu":false},"PageParams":{"menu":false}}}};
	}
